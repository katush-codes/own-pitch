"use strict";(()=>{var e={};e.id=145,e.ids=[145],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},852:e=>{e.exports=require("async_hooks")},6113:e=>{e.exports=require("crypto")},4492:e=>{e.exports=require("node:stream")},2781:e=>{e.exports=require("stream")},3837:e=>{e.exports=require("util")},1455:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>x,patchFetch:()=>f,requestAsyncStorage:()=>u,routeModule:()=>c,serverHooks:()=>g,staticGenerationAsyncStorage:()=>m});var d={};r.r(d),r.d(d,{POST:()=>l});var o=r(9303),s=r(8716),n=r(670),i=r(7070),p=r(1926),a=r(471);async function l(e){try{let{name:t,email:r,fund:d,cheque:o}=await e.json();if(!t||!r||!d||!o)return i.NextResponse.json({error:"All fields required"},{status:400});let s=(0,p.m)();return await s.from("deck_requests").insert({name:t,email:r,fund:d,cheque_size:o}),await Promise.allSettled([(0,a.cu)(r,t),(0,a.d1)({name:t,email:r,fund:d,cheque:o})]),i.NextResponse.json({success:!0})}catch(e){return console.error("deck-request error:",e),i.NextResponse.json({error:"Server error"},{status:500})}}let c=new o.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/deck-request/route",pathname:"/api/deck-request",filename:"route",bundlePath:"app/api/deck-request/route"},resolvedPagePath:"/Users/ownworkspace/Downloads/own-app/src/app/api/deck-request/route.ts",nextConfigOutput:"",userland:d}),{requestAsyncStorage:u,staticGenerationAsyncStorage:m,serverHooks:g}=c,x="/api/deck-request/route";function f(){return(0,n.patchFetch)({serverHooks:g,staticGenerationAsyncStorage:m})}},471:(e,t,r)=>{r.d(t,{AD:()=>a,Xu:()=>p,cu:()=>n,d1:()=>i});let d=new(r(6495)).R(process.env.RESEND_API_KEY),o=process.env.EMAIL_FROM||"Own. <investments@iown.app>",s=process.env.EMAIL_NOTIFY||"investments@iown.app";async function n(e,t){return d.emails.send({from:o,to:e,subject:"Own. — Your Investment Deck",html:`
    ...
    `})}async function i(e){return d.emails.send({from:o,to:s,subject:`New Deck Request — ${e.name} (${e.fund})`,html:`
    ...
    `})}async function p(e,t,r){return d.emails.send({from:o,to:e,subject:"Own. — DD Suite Access Granted",html:`
      <div style="background:#080808;color:#f5f2ec;font-family:sans-serif;padding:40px;max-width:560px;margin:0 auto;">
        <div style="font-size:2rem;font-weight:900;letter-spacing:0.05em;color:#00E2E2;margin-bottom:24px;">own.</div>
    ...
    `})}async function a(e){return d.emails.send({from:o,to:s,subject:`🔥 Investor Signed Term Sheet — ${e.name} ($${e.amount.toLocaleString()})`,html:`
      <div style="font-family:monospace;padding:24px;background:#f9f9f9;">
    ...
    `})}},1926:(e,t,r)=>{r.d(t,{m:()=>s});var d=r(7857);let o="https://kqqdfjmmsmidnjbjyonh.supabase.co";function s(){return(0,d.eI)(o,process.env.SUPABASE_SERVICE_ROLE_KEY,{auth:{autoRefreshToken:!1,persistSession:!1}})}(0,d.eI)(o,"sb_publishable_DSFj5DAw324J-jwrdYRzfg_hcMaoeAY")}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),d=t.X(0,[948,564,495],()=>r(1455));module.exports=d})();